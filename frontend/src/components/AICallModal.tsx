...
export default function AICallModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="AI Call" size="lg">
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-3 rounded-lg bg-light-50 border border-light-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-primary-600">AI Call</span>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-light-500">
            Edit the script as needed. The AI will use text-to-speech to deliver this script.
          </p>
        </div>
